...
public class InitDBCP extends HttpServlet{
	...
	public void init() throws ServletException {
		...
		bs.setUrl("jdbc:oracle:thin:@localhost:1521:xe"); 	// url 연결
		bs.setUsername("pc21");
		bs.setPassword("java"); 	// 비밀번호
		bs.setInitialSize(20);

				
		// dbcp.jsp에서는 application scope에 저장된 컨넥션풀을 사용하여 컨넥션 객체를 
		// 얻고 해제하는 과정을 반복 - 시간체크
		//application == ServletVontext
		
		ServletContext sc = getServletContext();	// application 생성
